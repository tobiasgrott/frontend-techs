...
import { makeLink, makeList, makeParagraph, makeSpan, renderView } from "./views.utils";
...
describe('makeLink', () => {
    ...
    it('Should pre a link to open in a new tabm if set', () => {
...
describe('makeList', () =>{
    it('Should create the correct type of list object', () => {
        const testCases: [string[], boolean, string][] = [
            // ListItems, ordered, exptedOutput
            [[], true, 'OL'],
            [[], false, 'UL'],
        ];
